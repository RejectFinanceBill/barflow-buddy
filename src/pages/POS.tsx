  ...
  return (
    <div className="flex gap-6 h-[calc(100vh-3rem)]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 mt-6 overflow-y-auto flex-1 pb-4 opacity-0 animate-fade-in" style={{ animationDelay: "200ms" }}>
      ...
      {/* Cart */}
      <div className="w-96 glass-card rounded-xl flex flex-col opacity-0 animate-slide-in-left" style={{ animationDelay: "100ms", animationDirection: "reverse", animationName: "none" }}>
